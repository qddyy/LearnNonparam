...
- This package uses `iterator` progress bar provided by the `cli` package, which can be customized. See <https://cli.r-lib.org/articles/progress-advanced.html#customization>. 
