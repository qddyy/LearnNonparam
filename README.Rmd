...
This package implements the tests in chapters 1-5 of [@Higgins2003](#references).
...
If you want to know all available methods and attributes, you can start by exploring `?PermuTest` (all tests' **base class**). 
