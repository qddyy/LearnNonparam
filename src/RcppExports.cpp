...
// association_pmt
NumericVector association_pmt(const SEXP x, const SEXP y, const SEXP statistic_func, const R_xlen_t n_permu, const bool progress);
...
// ksample_pmt
NumericVector ksample_pmt(const SEXP data, const SEXP group, const SEXP statistic_func, const R_xlen_t n_permu, const bool progress);
...
// multicomp_pmt
NumericVector multicomp_pmt(const SEXP group_i, const SEXP group_j, const SEXP data, const SEXP group, const SEXP statistic_func, const R_xlen_t n_permu, const bool progress);
...
// paired_pmt
NumericVector paired_pmt(const SEXP x, const SEXP y, const SEXP statistic_func, const R_xlen_t n_permu, const bool progress);
...
// rcbd_pmt
NumericVector rcbd_pmt(const SEXP data, const SEXP statistic_func, const R_xlen_t n_permu, const bool progress);
...
// table_pmt
NumericVector table_pmt(const SEXP row_loc, const SEXP col_loc, const SEXP statistic_func, const R_xlen_t n_permu, const bool progress);
...
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const SEXP >::type row_loc(row_locSEXP);
    Rcpp::traits::input_parameter< const SEXP >::type col_loc(col_locSEXP);
    Rcpp::traits::input_parameter< const SEXP >::type statistic_func(statistic_funcSEXP);
    Rcpp::traits::input_parameter< const R_xlen_t >::type n_permu(n_permuSEXP);
    Rcpp::traits::input_parameter< const bool >::type progress(progressSEXP);
...
// twosample_pmt
NumericVector twosample_pmt(const SEXP data, const SEXP where_y, const SEXP statistic_func, const R_xlen_t n_permu, const bool progress);
...
BEGIN_RCPP
    ...
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const SEXP >::type data(dataSEXP);
    Rcpp::traits::input_parameter< const SEXP >::type where_y(where_ySEXP);
    Rcpp::traits::input_parameter< const SEXP >::type statistic_func(statistic_funcSEXP);
    Rcpp::traits::input_parameter< const R_xlen_t >::type n_permu(n_permuSEXP);
    Rcpp::traits::input_parameter< const bool >::type progress(progressSEXP);
