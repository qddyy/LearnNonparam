...
multicomp_pmt <- function(group_i, group_j, data, group, statistic_func, n_permu, progress) {
    .Call(`_LearnNonparam_multicomp_pmt`, group_i, group_j, data, group, statistic_func, n_permu, progress)
}
...
twosample_pmt <- function(data, where_y, statistic_func, n_permu, progress) {
    .Call(`_LearnNonparam_twosample_pmt`, data, where_y, statistic_func, n_permu, progress)
}
